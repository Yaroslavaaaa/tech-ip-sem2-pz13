...
Система готова к расширению: можно добавлять новые типы событий, подключать дополнительные consumer'ы, реализовывать сложную маршрутизацию через exchanges.
